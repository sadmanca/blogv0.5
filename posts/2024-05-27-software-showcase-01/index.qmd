...
Use [**`asciinema`**](https://github.com/asciinema/asciinema) for recording terminal sessions to local `.cast` files, replaying `.cast` files in a terminals, & for uploading to [asciinema.org](https://asciinema.org)

* Recordings uploaded to [asciinema.org](https://asciinema.org) can be embedded as dynamic `asciinema` recordings in HTML webpages (like the ones you can see throughout this blog post!)
* On Windows, use [**`PowerSession-rs`**](https://github.com/Watfaq/PowerSession-rs) (a Windows-based drop-in replacement fork of `asciinema`)
...
```{=html}
<script id="asciicast-316444" src="https://asciinema.org/a/316444.js" data-speed="0.8" data-autoplay="true" data-loop="true" data-preload="false" async></script>
```
...
::: {#fig-record}
```{=html}
<script id="asciicast-e5jWLa6Ey0IIyHuSLAc4Saak8" src="https://asciinema.org/a/e5jWLa6Ey0IIyHuSLAc4Saak8" data-speed="3" data-autoplay="true" data-loop="true" data-preload="false" data-cols="80" data-rows="25" async></script>
```
...
```{.html}
<script src="https://asciinema.org/a/635483.js" id="asciicast-635483" async></script>
```
...
```{.html}
<script>
  src="https://asciinema.org/a/9593.js"
  id="..."
  data-start-at="00:40"
  data-autoplay="true"
  data-loop="true"
...
::: {#fig-another}
```{=html}
<script src="https://asciinema.org/a/635483.js" id="asciicast-635483-two" data-start-at="00:40" data-autoplay="true" data-loop="true" data-speed="2.75" data-idle-time-limit="2" data-theme="solarized-dark" data-cols="50" data-rows="18" data-preload="true" async></script>
```
