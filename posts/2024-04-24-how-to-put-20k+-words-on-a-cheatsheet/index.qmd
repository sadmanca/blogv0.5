---
title: "Putting 20k+ words on a 1MB cheat sheet"
description: "The art of maximizing content on a cheat sheet while maintaining readability"
date: "2024-04-24"
categories: ["Writing"]
format:
  html:
...
```{=html}
<iframe width="100%" height="500" src="ECE568-Final-Aid-Sheet.pdf" title="ECE568-Final-Aid-Sheet"></iframe>
```
:::

## The Medium

*Picking the tool of choice for writing your cheat sheet.*
...
I've successfully used Google Docs to make [a really dense cheat sheet](https://docs.google.com/document/d/1vug_KO224cEAZd4MW8AoRxETu7Sy-mOuxL9Ss_l2cfs/edit?usp=sharing) in the past (specifically, for an operating systems course, which, as any computer science or engineering student can tell you, has *oodles* of terminology and concepts that you need to remember), and while it was decent to some degree, it's lacking in a lot of ways (almost all of which are remedied by Typst). Here's just a few of why you shouldn't be using Google Docs for your cheat sheet:
...
::: {#fig-latex layout-ncol=2}

[![Front page](https://wch.github.io/latexsheet/latexsheet-thumb-0.png){#fig-front width=100% fig-alt="Front page of a LaTeX cheatsheet."}]

[![Back page](https://wch.github.io/latexsheet/latexsheet-thumb-1.png){#fig-back width=100% fig-alt="Back page of a LaTeX cheatsheet."}]

A decent-looking LaTeX cheatsheet, albeit one that isn't necessarily the best use of space. Source: <https://wch.github.io/latexsheet>
:::

[![A decent-looking LaTeX cheatsheet, albeit one that isn't necessarily the best use of space. Source: <https://wch.github.io/latexsheet>](https://wch.github.io/latexsheet/latexsheet-thumb-0.png)]

:::

```{.latex filename="latexsheet.tex"}
...
*Figuring out how to organize content on your cheat sheet.*
...
For a good example at what not to do, consider my cheat sheet for an [introductory digital logics course](https://engineering.calendar.utoronto.ca/course/ece241h1) from my second year of university. I can hardly distinguish the different groups of concepts amongst all the differently sized blocks of diagrams mixed in with text, and I was the one who wrote the entire darn thing, I can only imagine how you, dear reader, must feel looking at this spagetthi gobble of a cheat sheet.

::: {.column-margin}
![A spagetthi gobble of a cheat sheet](ece241.jpg)
:::
...
::: {.column-margin}
![Stint Ultra Expanded](https://assets.fonts.adobe.com/800x400/2GM1wZJFyicfbBsy9LqAbRN1)
:::
...
To see the whole project in action, take a look at <https://typst.app/project/rbJ15a29M2OcglqKcAuWkM>. But for an overview of how each individual part of the Typst project works together, continue on reading below. 

[Note that there are some minute differences between the code linked above and the overview below for clarity purposes.]{.aside}
