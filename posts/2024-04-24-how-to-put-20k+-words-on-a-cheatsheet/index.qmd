...
description: "The art of maximizing content on a cheatsheet while maintaining readability"
aliases: ["/typst-cheatsheet"]
date: "2024-04-24"
date-modified: "2024-05-28"
categories: ["University", "Python", "Typst"]
format:
  html:
    smooth-scroll: true
    syntax-definitions:
      - ../../misc/typst.xml
    code-links:
      - text: Typst Cheatsheet
        href: https://typst.app/project/rbJ15a29M2OcglqKcAuWkM
...
image: resources/cheatsheet.svg
open-graph:
  image: resources/cheatsheet.png
  image-alt: "A very dense cheatsheet"
twitter:
  image: resources/cheatsheet.png
  image-alt: "A very dense cheatsheet"

title-block-banner: "#43298c"
...
![Zoomed in (500%)](resources/zoomed.png)

![Zoomed out (front page)](resources/fullpage.png)
...
[^gh]: at [github.com/search?q=cheat+sheet+template&type=repositories](https://github.com/search?q=cheat+sheet+template&type=repositories)

:::{.column-page}

::: {#fig-latex layout-ncol=2}

![Front page](https://wch.github.io/latexsheet/latexsheet-0.png){#fig-front width=150% fig-alt="Front page of a LaTeX cheatsheet."}

![Back page](https://wch.github.io/latexsheet/latexsheet-1.png){#fig-back width=150% fig-alt="Back page of a LaTeX cheatsheet."}

A decent-looking LaTeX cheatsheet, albeit one that isn't necessarily the best use of space and is an absolute *pain* to edit in LaTeX. Source: <https://wch.github.io/latexsheet>
:::
...
[^overleaf]: ![Overleaf's new landing page (circa ~2023-2024), which is totally not a blatant copy of Typst's.](resources/overleaf.jpg)

[^typst]: ![Typst's landing page, which came out around late 2019-early 2020 (I should know, I was one of the first to sign up on the waitlist for the beta).](resources/typst.jpg)
...
For a good example at what not to do, consider my cheatsheet[^spagetthi] for an [introductory digital logics course](https://engineering.calendar.utoronto.ca/course/ece241h1) from my second year of university. I can hardly distinguish the different groups of concepts amongst all the differently sized blocks of diagrams mixed in with text, and I was the one who wrote the entire darn thing, I can only imagine how you, dear reader, must feel looking at this spagetthi gobble of a cheatsheet.

[^spagetthi]:
  ![A spagetthi gobble of a cheatsheet.](resources/ece241.jpg)
...
:::{.column-page}
```{=html}
<iframe width="100%" height="1000" src="resources/ECE568-Final-Aid-Sheet.pdf" title="ECE568-Final-Aid-Sheet"></iframe>
```
:::